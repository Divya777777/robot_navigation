...
* `robot_nav_description` - holds the sdf description of the simulated system and any other assets.

* `robot_nav_gazebo` - holds gazebo specific code and configurations. Namely this is where systems end up.

* `robot_nav_application` - holds ros2 specific code and configurations.

* `robot_nav_bringup` - holds launch files and high level utilities.
...
1. Launch the simulation
    ...
    ```bash
    ros2 launch robot_nav_bringup diff_drive.launch.py
    ```
